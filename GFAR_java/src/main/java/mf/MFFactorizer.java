...
/**
 * Notice that this code has been developed by Saul Vargas under RankSys package, we only modified it by ading a random seed
 ...
 */
public class MFFactorizer<U, I> extends MFALSFactorizer<U, I> {
     ...
     */
    public MFFactorizer(double lambda, DoubleUnaryOperator confidence, int numIter) {
     ...
     * @param numIter number of iterations
     */
    public MFFactorizer(double lambdaP, double lambdaQ, DoubleUnaryOperator confidence, int numIter) {
        super(numIter);
